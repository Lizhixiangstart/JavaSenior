...
/**
 * @author lzx
 * @create 2022-04-2022/4/30 10:19
 */
public class ReflectionTest {
    ...
    public void test1(){
        ...
        //在Person类外部，不可以通过Person类的对象调用其内部私有方法。
    ...
    public void test2() throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchFieldException {
        ...
        //通过反射，可以调用Person类的私有结构/比如：类的构造器、方法、属性
        ...
        String nation = (String) showNation.invoke(p1,"中国");//相当于showNation("中国");
    ...
    java.exe对某个字节码文件进行解释运行。相当于将某个字节码文件加载到内存中。
    此过程称为类的加载。加载到内存中的类，
