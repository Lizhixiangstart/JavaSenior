 ...
 *
 * @author lzx
 * @create 2021-12-2021/12/20 22:31
 */
/*
结论：
1常量与常量的拼接结果在常量池。并且常量池中不会存在相同内容的常量
2只要其中有一个是变量，结果就在堆中
...
public class StringTest {
   ...
   public void test3(){
       ...
       String s8 = s5.intern();//返回值得到的s8使用的常量池中已经存在的jaEEhadoop
    ...
    面试题：String s = new String("abc");方式创建对象，在内存中创建了几个对象？
              两个：一个时堆空间中new结构，另一个时char[]对应的常量池中的数据"abc";
     */
    ...
    public void test2(){
        ...
        String s1 = "javaEE";
        String s2 = "javaEE";
        //new + 构造器的方式：此时的s3和s4保存的地址值，时数据在堆空间中开辟空间以后对应的地址值
